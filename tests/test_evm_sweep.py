...
from EVM_Sweep import SweepConfig, SweepResultWriter, SweepRunner   # noqa: E402

class TestEVM_Sweep(unittest.TestCase):
    def setUp(self):
    ...
    def test_sweep_runner_execution_flow(self, mock_writer_class):
        ...
        self.assertEqual(mock_vsa.vsa_get_evm.call_count, 2)
