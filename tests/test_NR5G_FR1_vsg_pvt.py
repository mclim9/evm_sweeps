...
class TestNR5G_FR1_VSG_PVT(unittest.TestCase):
    def setUp(self):
        # Patch BenchConfig used inside NR5G_FR1_vsg_pvt to avoid socket creation
        self.bench_patcher = patch('driver.NR5G_FR1_vsg_pvt.BenchConfig')
    ...
    def test_vsg_configure_sends_commands(self):
        ...
        # For PVT drivers, they typically enable the generator state
