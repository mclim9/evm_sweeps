...
from ACLR_Suite import main  # noqa: E402

class Test_ACLR_Suite(unittest.TestCase):

    @patch('ACLR_Suite.BenchConfig')
    @patch('ACLR_Suite.VSA_driver')
    @patch('ACLR_Suite.VSG_driver')
    @patch('ACLR_Suite.SweepRunner')
